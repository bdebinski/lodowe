...
<head>
    ...
    <meta name="description"
        content="Profesjonalne rzeźby lodowe, bryły lodowe i dostawy lodu dla eventów, restauracji i barów. Ponad 18 lat doświadczenia w Łodzi.">
    <meta name="keywords" content="rzeźby lodowe, bryły lodowe, kostki lodu, pokazy lodowe, bary lodowe, eventy Łódź">
    <meta name="author" content="Lodowe.com.pl">

    <!-- Open Graph -->
    <meta property="og:title" content="Lodowe.com.pl - Rzeźby Lodowe & Profesjonalny Lód">
    <meta property="og:description" content="Tworzymy spektakularne dzieła lodowe i dostarczamy profesjonalny lód">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://lodowe.com.pl">

    <title>Lodowe.com.pl - Rzeźby Lodowe & Profesjonalny Lód | Łódź</title>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-cta">
                    ...
                    <a href="uslugi/produkty-z-lodu.html" class="btn btn-primary">
                        <i class="fas fa-envelope"></i> Złóż zamówienie
                    </a>
                ...
                <div class="about-visual">
                    <div class="about-image">
                        <div class="image-placeholder">
                            <img src="static/images/crew.webp" alt="" loading="lazy" width="600" height="400">
                        </div>
                    </div>
                    <div class="about-badge">
                        <div class="badge-number">18+</div>
            ...
            <div class="services-grid">
                <div class="service-card">
                    ...
                    <div class="service-links">
                        ...
                        <a href="uslugi/rzezby-lodowe.html" class="btn-link">
                ...
                <div class="service-card">
                    ...
                    <div class="service-links">
                        ...
                        <a href="uslugi/pokazy-warsztaty.html" class="btn-link">
                            Dowiedz się więcej <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="service-card">
                    ...
                    <div class="service-links">
                        ...
                        <a href="uslugi/produkty-z-lodu.html" class="btn-link">
                            Dowiedz się więcej <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="service-card">
                    ...
                    <div class="service-links">
                        ...
                        <a href="uslugi/bary-lodowe.html" class="btn-link">
                            Dowiedz się więcej <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="service-card">
                    ...
                    <p class="service-description">
                        ...
                        przewóz mroźniczo-chłodniczy. Oferujemy również wynajem samochodów (Fiat Ducato, Doblo, Scudo) jako mobilne mroźnie.
                    </p>
                    <ul class="service-features">
        ...
        <div class="container">
            ...
            <div class="faq-container">
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>W normalnych warunkach pokojowych (ok. 20°C) rzeźba lodowa utrzymuje się w dobrym stanie
                            przez 4-8 godzin. Czas ten można znacząco wydłużyć stosując odpowiednie chłodzenie i
                            zabezpieczenia.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Ceny zależą od rozmiaru, złożoności projektu i czasu realizacji. Podstawowa rzeźba (ok. 1m
                            wysokości) zaczyna się od 800 zł brutto. Duże, skomplikowane projekty mogą kosztować 2000-5000 zł brutto.
                        </p>
                        <p><strong>Uwaga:</strong> Wszystkie podane ceny są cenami brutto. Wyjątek stanowią: boxy termiczne, zamrażarki na lód oraz przewóz mroźniczo-chłodniczy.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="contact" id="contact">
        <div class="container">
            ...
            <div class="contact-wrapper">
                ...
                <div class="contact-info">
                    <div class="info-card">
                        ...
                        <h3>Biuro</h3>
                        <p>ul. Żeromskiego 49<br>90-624 Łódź</p>
                    </div>
                    ...
                    <div class="info-card">
                        ...
                        <h3>Email</h3>
                        <p>
                            <a href="mailto:office@long-table.com.pl">office@long-table.com.pl</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="map-container" style="margin-top: 60px;">
                ...
                <iframe
                    src="https://www.google.com/maps?q=ul.+%C5%BBeromskiego+49,+90-624+%C5%81%C3%B3d%C5%BA,+Poland&output=embed"
                    width="100%"
                    height="450"
